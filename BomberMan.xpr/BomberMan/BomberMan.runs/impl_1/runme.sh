...
HD_PWD='C:/Users/ASUS/OneDrive - National University of Singapore/Documents/BomberManMultiplayer.xpr/BomberMan/BomberMan.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log BomberGameTopLevel.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source BomberGameTopLevel.tcl -notrace
