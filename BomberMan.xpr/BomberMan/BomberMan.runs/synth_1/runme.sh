...
HD_PWD='C:/Users/ASUS/OneDrive - National University of Singapore/Documents/BomberManMultiplayer.xpr/BomberMan/BomberMan.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log BomberGameTopLevel.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source BomberGameTopLevel.tcl
